...
--
-- Table structure for table `coupon_distribution_logs`
--
...
--
-- Dumping data for table `coupon_distribution_logs`
--

LOCK TABLES `coupon_distribution_logs` WRITE;
/*!40000 ALTER TABLE `coupon_distribution_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `coupon_distribution_logs` ENABLE KEYS */;
UNLOCK TABLES;
